...
//  rbqProcessMessage(gotMessage, 0, RBQ_MSG_TYPE_CHAR)
//#endif

#ifdef SERIAL_DEBUG
  DEBUG_SERIAL.print(F("Calling rbqProcessMessage\n"));
  delay(1000);
 #endif // SERIAL_DEBUG

#ifdef SERIAL_DEBUG
  DEBUG_SERIAL.print("idData=");
  DEBUG_SERIAL.print((int(&idData)), HEX);
  DEBUG_SERIAL.print("\n");
  delay(1000);
#endif // SERIAL_DEBUG

  rbqProcessMessage((uint8_t *)&idData, totalDataLength, RBQ_MSG_TYPE_SENSOR_BIN);
